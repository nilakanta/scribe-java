...
public class Google20Example
{
  ...
  private static final Token EMPTY_TOKEN = Token.empty();
  ...
  public static void main(String[] args)
  {
    try {
      ...
      String apiKey = "57788468046-sodruh05b65ggcoterm4m7i3ji5tjhf1.apps.googleusercontent.com";
      String apiSecret = "7rNNpC2_uzqd-CUNu8kk7jv9";
